...
if __name__ == "__main__":
    ...
    # Read list of atlases (i.e., image and its corresponding point set)
    atlas_files = {
    ...
    affine_params = sitk.GetDefaultParameterMap('affine', 3)
    affine_params['MaximumNumberOfIterations'] = ['1000']
    elx_params.append(affine_params)

    bspline_params = sitk.GetDefaultParameterMap('bspline', 2, 64)
    bspline_params['Metric1Weight'] = ['20000']
    bspline_params['MaximumNumberOfIterations'] = ['1000']
    ...
    print('\nPredicting points for input images:\n')
